package SoundFile;// Wav file IO class
// A.Greensted
...
public class WavFile
{
	...
	// Cannot instantiate Others.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from Others.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to Others.WavFile instance");
